...
namespace Jarvis
{
  TranslationProcessor::TranslationProcessor(string name, float start, float end, float increment, vec3 axis, shared_ptr<Entity> entity) : Processor(name, false, false),
    m_start(start),
    m_end(end),
